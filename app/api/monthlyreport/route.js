...
import { getAdminLeaveReport } from "@/actions/adminLeaveActions";
import { generateAdminTable, sendMail } from "@/actions/utils";
...
export async function GET() {
  ...
  try {
    ...
    console.log("res: ", res);
    return new NextResponse({ error: "Report sent successfully" }, { status: 200 });
  } catch (error) {
